...
- [Filedrop App](https://github.com/Utkarsh9571/FileDrop-File-sharing-app.git): Provisioned GKE cluster with TLS, Ingress, and backend routing
- [Subscription Tracker](https://github.com/Utkarsh9571/Subscription-tracker.git): Debugged EKS node group provisioning and refactored Terraform for reproducibility
